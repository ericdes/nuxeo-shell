...
"%JAVA%" %JAVA_OPTS% -jar nuxeo-runtime-launcher-1.4.4-SNAPSHOT.jar bundles/nuxeo-runtime-osgi-1.4.4-SNAPSHOT.jar/org.nuxeo.osgi.application.Main bundles/.:lib/.:config -bundles=bundles/nuxeo-shell-commands-base.jar@3 -home . -console %*
